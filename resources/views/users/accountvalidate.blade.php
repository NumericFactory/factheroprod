  ...
  <div style="max-width: 700px;" class="container">
    <div style="background:transparent; max-width: 700px;" class="red-bg">
     ...
     <!--  <h2>Sortie en Juin 2017 ...</h2> -->
      ...
      <h2>Ok votre compte est bien validé.<br><br></h2>
       <p class="" style="color:#93c3d8; margin:1px !important; font-weight: bold; font-size:1.77rem;"">
          <br>
          <br>
          <u>Je vous tiendrai informé(e) par email de la sortie</u> de la version beta.
	<br>
          <br>
          Vous pouvez également suivre l'évolution sur la page Facebook.
<br>
          <br>
          Frédéric.
